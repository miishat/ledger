...
export const MarketDataSettings: React.FC = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4 pt-[8vh] overflow-y-auto"
        ...
        >
          <div
            className="themed-menu rounded-lg w-full max-w-md p-6 flex flex-col gap-3"
