          ...
          <div className="w-full lg:w-2/3 flex flex-col gap-4 border-t lg:border-t-0 lg:border-l border-[var(--color-border)] pt-4 lg:pt-0 lg:pl-8">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex justify-between items-center py-3 border-b border-[var(--color-border)]">
                ...
                <div className="w-1/4 flex justify-end">
                  <span className={calcAnnualBonus(comparePackage, timeMode) - calcAnnualBonus(primaryPackage, timeMode) > 0 ? "text-green-600 bg-green-50 px-2 py-0.5 rounded text-[12px] font-medium" : calcAnnualBonus(comparePackage, timeMode) - calcAnnualBonus(primaryPackage, timeMode) < 0 ? "text-error bg-red-50 px-2 py-0.5 rounded text-[12px] font-medium" : "text-[var(--color-text-secondary)] bg-[var(--color-bg-secondary)] px-2 py-0.5 rounded text-[12px] font-medium"}>
              ...
              <div className="flex justify-between items-center py-3 border-b border-[var(--color-border)]">
                ...
                <div className="w-1/4 flex justify-end">
                  <span className={calcAnnualRRSP(comparePackage, timeMode) - calcAnnualRRSP(primaryPackage, timeMode) > 0 ? "text-green-600 bg-green-50 px-2 py-0.5 rounded text-[12px] font-medium" : calcAnnualRRSP(comparePackage, timeMode) - calcAnnualRRSP(primaryPackage, timeMode) < 0 ? "text-error bg-red-50 px-2 py-0.5 rounded text-[12px] font-medium" : "text-[var(--color-text-secondary)] bg-[var(--color-bg-secondary)] px-2 py-0.5 rounded text-[12px] font-medium"}>
              ...
              <div className="flex justify-between items-center py-3 border-b border-[var(--color-border)]">
                ...
                <div className="w-1/4 flex justify-end">
                  <span className={calcAnnualRSU(comparePackage, timeMode) - calcAnnualRSU(primaryPackage, timeMode) > 0 ? "text-green-600 bg-green-50 px-2 py-0.5 rounded text-[12px] font-medium" : calcAnnualRSU(comparePackage, timeMode) - calcAnnualRSU(primaryPackage, timeMode) < 0 ? "text-error bg-red-50 px-2 py-0.5 rounded text-[12px] font-medium" : "text-[var(--color-text-secondary)] bg-[var(--color-bg-secondary)] px-2 py-0.5 rounded text-[12px] font-medium"}>
