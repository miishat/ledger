...
```
Agent(
  prompt="Read C:/Users/misha/ledger/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/misha/ledger/.claude/gsd-core/templates/VALIDATION.md`
