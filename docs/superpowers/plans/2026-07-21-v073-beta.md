...
- [ ] **Step 5: Drop the Task 7 test casts**
...
Run: `npx vitest run src/utils/portfolioCsv.test.ts src/utils/investments/portfolioMetrics.test.ts`
Expected: PASS.
...
```bash
git add src/utils/portfolioCsv.ts src/utils/portfolioCsv.test.ts src/store/usePortfolioStore.ts src/utils/investments/portfolioMetrics.test.ts
