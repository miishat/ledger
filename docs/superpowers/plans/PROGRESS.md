...
- **Last completed task:** Phase 4e, Task 4 — compensation lump-sum feed (commits 30bbf4a+55f1c43)
- **Next task:** Phase 4e, Task 5 — forecaster settings + auto-feed resolution
